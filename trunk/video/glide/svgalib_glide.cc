...
class i4_svgalib_glide_display_class : public i4_glide_display_class
{
public:
  ...
  virtual void destroy_window() {  input.close_console(); }

  virtual i4_bool create_window()
  {
    return input.open_console(tmp.xres,tmp.yres);
  }
...
i4_svgalib_glide_display_class i4_svgalib_glide_display_instance;
